...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Iнформацiя про фiльм:");
        ...
        Successfully obj3 = new Successfully(200000000, 50, 150);
        obj3.setSuccessfully(true);

        System.out.println("Iнформацiя про успiшнiсть зйомки");
        obj3.printSuccessfullyStatus();
    }
}